...
$(document).ready(function(){
					countChar = function(str, charVal){
	var countVal=0
  ...
  return result    
	...
	/////////////Converting Root Symbol/////////////// 			   
	 checkRootIndex = function(inputStr){
		// alert()
						...
						var splitedInputString=String(inputString).split("√")
						beforeRad=splitedInputString[0]
					
						for ( var i = 1; i<splitedInputString.length;i++){
							
							index1 = splitedInputString[i].indexOf("(");
							index2 = splitedInputString[i].indexOf(")");
							//alert(index1+" "+index2)
							rootStr += (String(splitedInputString[i]).substr(index1,index2-index1+1))+"^(1/2)"+String(splitedInputString[i]).substr(index2+1, String(splitedInputString[i]).length+1)
							
							}
						
						finalRootStr = beforeRad+""+rootStr
						
						
						}
						else{
								finalRootStr = inputString
							}
