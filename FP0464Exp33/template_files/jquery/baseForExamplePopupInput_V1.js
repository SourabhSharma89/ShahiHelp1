...
$(".solution").click(function(){ checkSpace=false;                                                                                                                                                                           window.ClickToAnsDiv = 0;                                                                 
   ForSolutionShow = 1;	
...
$(".ClickToAnsDiv").click(function(){
							...
							}else{$(".done1").css({"width":deletewidth*3+"px","height":deleteHeight*1.5+"px"});$(".OuterDivForInputAndRadio").show();$(".OuterDivForInputAndRadioForDevice").hide();}
							 ...
							 //alert("In If")
								...
								$(".AreaForKeypadAndInputInDevice").css({"height":DeviceKeypadArea+"px"});
 								$(".inputAndDoneSpaceFordevice").css({"height":DeviceKeypadArea +"px"});
									...
									$(".inputAndDoneSpaceFordevice").css({"height":DeviceKeypadArea-100+"px"});
